    ...
    <div name="contact" className="w-full bg-gradient-to-b from-black to-gray-800 text-white">
      <div className="flex flex-col px-4 pt-24 justify-center max-w-7xl mx-auto md:px-8">
        ...
        <div className="flex justify-center items-center">
          <form action="https://getform.io/f/05fe9ea6-d087-4045-ba6e-3b491a5a36a9" method="POST" className="flex flex-col w-full md:w-1/2">
            ...
            <button type="submit" className="text-white bg-gradient-to-b from-cyan-500 to-blue-500 px-6 py-3 my-8 mx-auto flex items-center rounded-md hover:scale-110 duration-300">Get in touch</button>
          </form>
        </div>
      </div>
    </div>
